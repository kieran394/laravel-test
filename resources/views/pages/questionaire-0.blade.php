@extends('layouts.app')
@section('content')
    <h1>Questionaire: {{$questionaires[0]->name}}</h1>
    ...
    <form method="post" action="/create" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <label for="favsportteamid" class="col-sm-3 col-form-label">Favourite football team</label>
            <div class="col-sm-9">
                <input name="favourite_sport_team" type="text" class="form-control" id="favsportteamid"
                       placeholder="Favourite football team">
            </div>
        </div>
        <input type="hidden" id="questionaireId" name="questionaireId" value={{$questionaires[0]->id}}>
        <input type="hidden" id="questionaireSlugName" name="questionaireSlugName" value={{$questionaires[0]->question_slug}}>
        <div class="form-group row">
